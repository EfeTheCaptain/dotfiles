...
echo -e "\n\033[38;5;34m╭──[ ${package_count} \n\033[38;5;34]───[\033[0m${os_logo}\033[38;5;34m]"
echo -e "\033[38;5;34m╰───[ ${cpu_model} ]\033[0m\n"


# Define PS1 (with \[ \] for prompt safety)
PS1="\n\
\[\033[38;5;34m\]╭───[\[\033[38;5;220m\]\u\\[\033[38;5;34m\]@\h\[\033[38;5;034m\]]──[\[\033[38;5;045m\]\w\[\033[38;5;034m\]]\n\
\[\033[38;5;34m\]╰─🠞 \[\033[0m\] "
